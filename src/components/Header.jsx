    ...
    <>
      ...
      <header className="fixed top-0 left-0 right-0 z-40 bg-[#0f0f0f]/95 backdrop-blur border-b border-gray-800">
        <div className="flex items-center gap-4 sm:gap-10 px-4 h-14 relative">
          ...
          {/* Saludo personalizado compacto (Centro - Flujo Normal) */}
          <div className="flex-1 hidden sm:flex justify-center">
            {usuario && (
              <div className={`flex items-center gap-1.5 px-3 py-1 rounded-xl ${estilos.bg} ${estilos.border} border animate-in fade-in zoom-in duration-300`}>
